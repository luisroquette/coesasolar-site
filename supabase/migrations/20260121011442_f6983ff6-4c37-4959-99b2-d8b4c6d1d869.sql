-- Remover a versão antiga com filter_agent UUID
DROP FUNCTION IF EXISTS public.match_rag_chunks(extensions.vector, double precision, integer, text[], uuid);

-- Recriar apenas a versão com filter_agent TEXT
DROP FUNCTION IF EXISTS public.match_rag_chunks(extensions.vector, double precision, integer, text[], text);
