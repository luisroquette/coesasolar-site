...
/**
 * maria-webhook: Wrapper for marIA agent
 * 
 * This is a lightweight wrapper that forwards requests to z-api-webhook
 * with the agent_id set to 'maria'. The z-api-webhook handles message
...
serve(async (req) => {
  ...
  try {
    ...
    console.log('[maria-webhook] Forwarding request to z-api-webhook with agent_id: maria');
    ...
    console.log('[maria-webhook] Response status:', response.status);
    ...
    console.error('[maria-webhook] Error:', error);
