...
export function SortableAgentCard({ agent, onEdit, onDownload, onStatusChange, isAdmin }: SortableAgentCardProps) {
  ...
  return (
    <div ref={setNodeRef} style={style}>
      <Card className={`group hover:shadow-md transition-all ${isDragging ? 'shadow-lg ring-2 ring-primary' : ''}`}>
